...
CLASS lsc_z7409_r_travel IMPLEMENTATION.
  ...
  METHOD save_modified.
    ...
    LOOP AT create-item ASSIGNING FIELD-SYMBOL(<item_c>).
      msg = model->create_item( CORRESPONDING #( <item_c> MAPPING FROM ENTITY ) ).
      IF msg IS NOT INITIAL.
        INSERT VALUE #(
          itemuuid = <item_c>-itemuuid
          %msg = map_message( msg )
        ) INTO TABLE reported-item.
      ENDIF.
    ENDLOOP.
